...
class DocumentgeneralController extends Controller
{
    ...
    {
        $this->middleware('input.request:documentgeneral,web', ['only' => ['store']]);
    }
    ...
    public function create()
    {
        ...
        return view('tenant.documentsgeneral.form');
    ...
    public function create2($quotation_id)
    {
        $user = auth()->user();
        $pos = \App\Models\Tenant\Pos::active();
        return view('tenant.documentsgeneral.form2', compact('quotation_id', 'user', 'pos'));
    }
