...
use App\CoreFacturalo\Helpers\Storage\StorageServicio;
...
use App\Http\Resources\Tenant\ServicioCollection;
use App\Http\Resources\Tenant\DocumentResource;

use App\Http\Resources\Tenant\ServicioResource;
...
class ServicioController extends Controller
{
    ...
    {
        $this->middleware('input.request:servicio,web', ['only' => ['store']]);
    }

    public function index()
    {
        return view('tenant.servicio.index');
    }
    ...
    {
        return view('tenant.servicio.configuration');
    }
    ...
    public function records(Request $request)
    {
        ...
        return new ServicioCollection($records->paginate(env('ITEMS_PER_PAGE', 10)));
    }
    ...
    public function totals(Request $request)
    {
        ...
        $total_state_types = DB::connection('tenant')
            ...
            ->where($request->column, 'like', "%{$request->value}%")
            ->whereIn('doc.document_type_id', ['80'])
    ...
    public function create()
    {
        ...
        return view('tenant.servicio.form');
    ...
    public function create2($quotation_id)
    {
        $user = auth()->user();
        $pos = \App\Models\Tenant\Pos::active();
        return view('tenant.servicio.form2', compact('quotation_id', 'user', 'pos'));
    }
    // public function create2($servicio_id)
    // {
    //     $user = auth()->user();
    //     $pos = \App\Models\Tenant\Pos::active();
    //     return view('tenant.servicio.form2', compact('servicio_id', 'user', 'pos'));
    ...
    public function tablas()
    {
        ...
        $series = Series::all();
        $document_types_invoice = DocumentType::whereIn('id', ['80'])->get();
        $document_types_invoice2 = DocumentType::whereIn('id', ['80'])->get();
    ...
    public function tables2($quotation_id = false)
    {
        ...
        $quotation = Servicio::whereId($quotation_id)->get();
