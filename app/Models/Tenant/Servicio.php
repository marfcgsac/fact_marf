...
class Servicio extends ModelTenant
{
    ...
    {
        return route('tenant.download.external_id', ['model' => 'servicio', 'type' => 'xml', 'external_id' => $this->external_id]);
    }

    public function getDownloadExternalPdfAttribute()
    {
        return route('tenant.download.external_id', ['model' => 'servicio', 'type' => 'pdf', 'external_id' => $this->external_id]);
    }

    public function getDownloadExternalCdrAttribute()
    {
        return route('tenant.download.external_id', ['model' => 'servicio', 'type' => 'cdr', 'external_id' => $this->external_id]);
    }
