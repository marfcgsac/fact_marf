...
Vue.component('tenant-documents-pay', require('./views/tenant/documents/pay.vue'));
...
Vue.component('tenant-servicio-invoice', require('./views/tenant/servicio/invoice.vue'));
Vue.component('tenant-servicio-invoice2', require('./views/tenant/servicio/invoice2.vue'));
Vue.component('tenant-servicio-note', require('./views/tenant/servicio/note.vue'));
Vue.component('tenant-servicio-configuration', require('./views/tenant/servicio/configuration.vue'));
//fin orden servicio
