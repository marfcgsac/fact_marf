    ...
    <div>
        <div class="page-header pr-0">
            ...
            <ol class="breadcrumbs">
                ...
                <li><span class="text-muted">Facturas-Boletas-Orden de servicio <small></small></span></li>
            </ol>
        ...
        <div class="card mb-0">
                    ...
                    <tr slot-scope="{ index, row }" slot="tbody" :class="{
                       ...
                       //     'bg-danger': (row.state_type_id === '11'),
                        ...
                        <td class="text-center">
                            ...
                            <!-- <el-tooltip class="item text-center" effect="dark" v-else="" content="Enviar a SUNAT/OSE" placement="top-end">
                            ...
                            <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                                <div class="btn-group" role="group">
                                     ...
                                     <button  type="button" class="btn waves-effect waves-light btn-xs btn-info m-1__2"  @click.prevent="clickDownload(row.download_pdf)" v-if="row.has_pdf">PDF</button>
            ...
            <documentgeneral-voided :showDialog.sync="showDialogVoided"
                            :recordId="recordId"></documentgeneral-voided>

            <documentgeneral-options :showDialog.sync="showDialogOptions"
                              :recordId="recordId"
                              :showClose="true"></documentgeneral-options>
            <documentgeneral-pay :showDialog.sync="showDialogPay"
                            :recordId="recordId" :resource="resource"></documentgeneral-pay>
        </div>
    </div>
</template>
...
<script>
    ...
    import DocumentgeneralVoided from './partials/voided.vue'
    import DocumentgeneralPay from './partials/pay.vue'
    import DocumentgeneralOptions from './partials/options.vue'
    import DataTable from '../../../components/tableitems.vue'

    export default {
        components: {DocumentgeneralVoided, DocumentgeneralOptions, DataTable, DocumentgeneralPay},
        data() {
            return {
