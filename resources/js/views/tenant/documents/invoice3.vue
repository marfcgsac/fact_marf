...
<script>
    ...
    export default {
        ...
        async created() {
            await this.initForm()
            await this.$http.get(`/${this.resource}/tables3/${this.sale_note_id}`)
                .then(response => {
                    ...
                    this.form.customer_id = response.data.sale_notes[0].customer_id                     
                    this.identity_document_type_id = response.data.sale_notes[0].customer.identity_document_type_id
            ...
            await this.$http.get(`/${this.resource}/item/tables3/${this.sale_note_id}`)
            .then(response => {
        ...
        methods: {
            ...
            close() {
                location.href = '/sale_notes'
            },
            reloadDataCustomers(customer_id) {
                this.$http.get(`/${this.resource}/table3/customers`).then((response) => {
