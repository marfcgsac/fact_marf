    ...
    <div>
        <div class="page-header pr-0">
            ...
            <div class="right-wrapper pull-right">
                <a :href="`/servicio/create`" class="btn btn-custom btn-sm  mt-2 mr-2"><i class="fa fa-plus-circle"></i> Nuevo</a>
            </div>
        </div>
        <div class="card mb-0">
                ...
                <data-table :resource="resource">
                   ...
                   <tr slot-scope="{ index, row }" slot="tbody" :class="{
                        ...
                        <td class="text-center">
                            ...
                            <el-tooltip class="item" effect="dark" content="Guía de Remisión" placemnt="top-end">
...
<script>
    ...
    import DataTable from '../../../components/tableservicio.vue'
