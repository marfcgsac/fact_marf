        ...
        <form autocomplete="off" @submit.prevent="submit">
            <div class="form-body">
                <div class="row">
                    ...
                    <!-- aumentar detalle -->
                     <div class="col-md-12">
                        <div class="form-group" :class="{'has-danger': errors.detalle}">
                            <label class="control-label">Detalle <span class="text-danger">*</span></label>
                            <el-input v-model="form.detalle" dusk="detalle"></el-input>
                            <small class="form-control-feedback" v-if="errors.detalle" v-text="errors.detalle[0]"></small>
                        </div>
                    </div>
                    <!-- fin aumentar -->
                    <div class="col-md-3">
