<template>
    <div>
        <div class="page-header pr-0">
            ...
            <a v-else href="./pos1/register" target="_blank"
        ...
        <div class="card mb-0">
            ...
            <new-pos1-register :show-dialog.sync="showNewRegisterDialog" @OpenPos="OpenPos"></new-pos1-register>
            <pos1-details :show-dialog.sync="showPosDetailsDialog"
                              :registers.sync="posDetailsData"></pos1-details>
        </div>
