    ...
    <div class="container-fluid m-0 pb-0">
        <div class="row flex-row">
            ...
            <div class="col-xs-12 col-md-6">
                <div class="input-group input-group-lg border  rounded">
                    ...
                    <input type="text" class="form-control" placeholder="Buscar Productos por Nombre o Codigo" v-model="searchBox"
                ...
                <div class="mt-3 overflow-auto scrollbar scrollbar-secondary" style="white-space: nowrap">
                 <div class="d-flex flex-row flex-wrap p-2 ">

                    <div >
                    
                    <button type="button" class="btn btn-pill btn-primary" v-on:click="selectCategoria=0">Todos (All)</button>
                    <button type="button" class="btn btn-pill btn-primary" style="margin:4px" v-for="cat in listCat" v-on:click="selectCategoria=cat.id">{{cat.description}} </button>
              ...
              <div class="mt-3 overflow-auto h-100 border rounded rounded-0 scrollbar scrollbar-secondary" style="max-height: 75vh">
                      ...
                      <div class="d-flex flex-row flex-wrap p-2">
                         ...
                         <div  style="cursor: pointer" @click.prevent="selectItem(prod.id)" >

                            <div class="card-header p-1 bg-success text-white" style="font-weight: 700">{{prod.internal_id}}</div>
                                <div class="card-body p-1 text-dark">
                                 <span style="font-weight: 500"   >{{prod.description}}</span> <br>
                                     <small>{{prod.unit_type_id}}</small>
                                     <br>
                                     <span class="font-weight-bold text-primary h6">
                                    {{prod.currency_type.symbol}}  {{ formaterNumber(prod.sale_unit_price, decimal) }}
                                </span>
                            </div>
                        </div>
                    </div>
       ...
       <div class="mt-3 overflow-auto h-100 border rounded rounded-0 scrollbar scrollbar-secondary" style="max-height: 75vh">
              ...
              <div class="d-flex flex-row flex-wrap p-1 ">
                        ...
                        >
                            <div class="card-header p-1 bg-success text-white" style="font-weight: 700">{{option.internal_id}}</div>
                            <div class="card-body p-1 text-dark">
                                 <span style="font-weight: 500"   >{{option.description}}</span> <br>
                ...
                <div class="card mb-0">
                    <div class="card-header  bg-nuevo p-1">
                        <h5 class="m-0 p-0">
                            ...
                            Ventaqqqqqqqqqqqqqqqqqqqqqqqqqqqq
                        </h5>
                    </div>
                        ...
                        <table class="table table-striped table-bordered table-sm m-0 p-0">
                            ...
                            <tr v-for="(row, index) in form.items">
                               ...
                               <td class="text-center pl-0 pr-0">
                                    <button type="button"
                                            class="btn waves-effect waves-light btn-xs btn-liza-color"
                        ...
                        <div class="row">
                            ...
                            <div class="col-6 pt-3">
                                <p class="text-right text-white mb-1" v-if="form.total_exportation > 0">
                                    OP.EXPORTACIÃ“N: {{ currency_type.symbol }} {{ form.total_exportation }}
                                </p>
                ...
                <form autocomplete="off" @submit.prevent="submit">
                    <div class="form-body">
                        <div class="row">
                            ...
                            <div class="col-lg-2">
                                <div class="form-group" :class="{'has-danger': errors.operation_type_id}">
                                    <label class="control-label">Tipo OperaciÃ³n</label>
                        ...
                        <div class="row mt-1">
                            ...
                            <div class="col-lg-2">
                                <div class="form-group" :class="{'has-danger': errors.date_of_issue}">
                                    <label class="control-label">Fecha de emisiÃ³n</label>
                        ...
                        <div class="row mt-2">
                            <div class="col-md-12">
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tr>
                                            <th>#</th>
                                            <th class="font-weight-bold">DescripciÃ³n</th>
                            ...
                            <div class="col-md-12">
                                <p class="text-right" v-if="form.total_exportation > 0">OP.EXPORTACIÃ“N: {{
