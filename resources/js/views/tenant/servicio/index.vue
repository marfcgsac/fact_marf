    ...
    <div>
        <div class="page-header pr-0">
            ...
            <ol class="breadcrumbs">
                ...
                <li><span class="text-muted"><small>ORDEN DE SERVICIO</small></span></li>
            </ol>
            ...
            <div class="card-body ">
                <data-table :resource="resource">
                    ...
                    <tr slot-scope="{ index, row }" slot="tbody" :class="{
                        ...
                        <td class="text-right">
                            ...
                            <el-tooltip class="item" effect="dark" content="Visualizar" placement="top-end">
                                <a :href="`/documents/view/${row.id}`" class="btn btn-xs"><i class="fa fa-eye i-icon text-info"></i></a>
                            </el-tooltip>
                            ...
                            <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                                <div class="btn-group" role="group">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                        ...
                                        <!-- <a v-if="row.state_type_id==14" class="dropdown-item" :href="`/servicio/create2/`+row.id">Crear venta</a> -->
                    ...
                    <div class="row col-md-12 justify-content-center" slot-scope="{ totals }" slot="totals">
                        <div class="col-md-3">
                            <h5><strong>Total de Orden de servicio en soles </strong>S/. {{ totals.total.total }}</h5>
...
<script>
    ...
    // import ServicioVoided from './partials/voided.vue'
    // import DocumentsPay from './partials/pay.vue'
    // import ServicioOptions from './partials/options.vue'
    ...
    export default {
        ...
        //{ServicioVoided, ServicioOptions, DataTable, DocumentsPay},
        data() {
            return {
