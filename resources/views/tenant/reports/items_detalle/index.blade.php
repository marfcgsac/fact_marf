        ...
        <div class="col-md-12">
            <div class="card card-primary">
                <div class="card-header">
                    <div>
                        <h4 class="card-title">Reporte de items detalle</h4>
                    </div>
                </div>
                <div class="card-body">
                    <div>
                        <form action="{{route('tenant.reports.items_detalle.search')}}" class="el-form demo-form-inline el-form--inline" method="POST">
                            {{csrf_field()}}
                            <tenant-calendaredith :document_types="{{json_encode($documentTypes)}}" :establishments="{{json_encode($establishments)}}" data_d="{{$d ?? ''}}" data_a="{{$a ?? ''}}" establishment_td="{{$establishment_td ?? null}}" td="{{$td ?? null}}"></tenant-calendaredith>
                        </form>
                        <div class="row">
                 <div class="col-md-12">
                    ...
                    <div class="box">
                        <div class="box-body no-padding">
                            <div style="margin-bottom: 10px">
                                @if(isset($records2))
                                    <form action="{{route('tenant.report.items_detalle.pdf')}}" class="d-inline" method="POST">
                                        {{csrf_field()}}
